...
public class BtEventsDataHandlerTest {
    ...
    public void testTeamsIgnored() {
        Optional<Organisation> parsed = handler.parseOrganisation(new BtTeam(), BtSportType.UFC);
    ...
    public void testEventParsing() {
        ...
        assertEquals(utility.fetchLocationUrl(match.location()).get().getUri(), parsedEvent.venue().getValue());
