...
public class PaArchivesProgExtractorTest {
    ...
    public void testIngestHierarchyFromProgdata() throws Exception {
        ...
        Set<Alias> aliases = ImmutableSet.of(new Alias("pa:film", "5217"), new Alias("rt:filmid", "5217"), new Alias("gb:pressassociation:prod:prog_id", "263544"));
        ...
        assertThat(item.getCanonicalUri(), is("http://pressassociation.com/films/5217"));
