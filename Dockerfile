...
CMD java \
    ...
    -Dyouview.upload.unbox.password="fakepass" \
    -Dyouview.upload.unbox.upload.enabled="true" \
    -Dyouview.upload.unbox.test="true" \
    -Dyouview.upload.unbox.url="amazon.fake.url" \
    -Dyouview.upload.unbox.username="fakeusername" \
