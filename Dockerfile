...
ENV SERVER_PORT="8080" \
    ...
    YOUVIEW_UPLOAD_NITRO_EQUIVAPIKEY="" \
    YOUVIEW_UPLOAD_UNBOX_UPLOAD_ENABLED="false" \
    YOUVIEW_UPLOAD_UNBOX_EQUIVAPIKEY="" \
...
CMD java \
    ...
    -Dyouview.upload.nitro.equivapikey="$YOUVIEW_UPLOAD_NITRO_EQUIVAPIKEY" \
    ...
    -Dyouview.upload.unbox.equivapikey="$YOUVIEW_UPLOAD_UNBOX_EQUIVAPIKEY" \
