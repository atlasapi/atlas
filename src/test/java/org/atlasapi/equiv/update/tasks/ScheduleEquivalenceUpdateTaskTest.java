...
public class ScheduleEquivalenceUpdateTaskTest {
    ...
    public void testUpdateScheduleEquivalences() {
        ...
        ScheduleChannel schChannel1 = new ScheduleChannel(
                bbcOne,
                ImmutableList.of(yvItemOne, yvItemTwo)
        );
        LocalDate today = new LocalDate();
        LocalDate tomorrow = today.plusDays(1);
        Schedule schedule1 = new Schedule(
                ImmutableList.of(schChannel1),
                new Interval(today.toDateTimeAtStartOfDay(), tomorrow.toDateTimeAtStartOfDay())
        );
        ...
        verify(updater).updateEquivalences(yvItemOne, null, null);
        verify(updater).updateEquivalences(yvItemTwo, null, null);
    }
}
