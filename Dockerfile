...
ENV SERVER_PORT="8080" \
    ...
    TELESCOPE_HOST="" \
    TELESCOPE_CORE_REPORTING_THREADS=3 \
    TELESCOPE_MAX_REPORTING_THREADS=10 \
    TELESCOPE_QUEUE_SIZE=1000 \
    TELESCOPE_REPORTING_THREAD_NAME="owl-to-telescope" \
    TELESCOPE_METRICS_PREFIX="owl" \
