...
//            .put("The Enclosed Ground", new LocationTitleUri("The Enclosed Ground", "http://dbpedia.org/resource/"))) // CANNOT BE MATCHED https://en.wikipedia.org/wiki/Whitehawk_F.C.
            ...
            .put("bet365 Stadium", new LocationTitleUri("Britannia Stadium", "http://dbpedia.org/resource/Britannia_Stadium"))
            .put("Ibrox Stadium", new LocationTitleUri("Ibrox Stadium", "http://dbpedia.org/resource/Ibrox_Stadium"))
            .put("Global Energy Stadium", new LocationTitleUri("Victoria Park", "http://dbpedia.org/resource/Victoria_Park,_Dingwall"))
            .put("SuperSeal Stadium", new LocationTitleUri("New Douglas Park", "http://dbpedia.org/resource/New_Douglas_Park"))
            .put("Ramón Sánchez-Pizjuán", new LocationTitleUri("Ramón Sánchez-Pizjuán Stadium", "http://dbpedia.org/resource/Ram%C3%B3n_S%C3%A1nchez_Pizju%C3%A1n_Stadium"))
            .put("SIGNAL IDUNA PARK", new LocationTitleUri("Westfalenstadion","http://dbpedia.org/resource/Westfalenstadion"))
            .put("Noordlease Stadion", new LocationTitleUri("Euroborg", "http://dbpedia.org/resource/Euroborg"))
            .put("London Stadium", new LocationTitleUri("Olympic Stadium", "http://dbpedia.org/resource/Olympic_Stadium_(London)"))
            .put("KCOM Stadium", new LocationTitleUri("KC Stadium", "http://dbpedia.org/resource/KC_Stadium"))
            .put("Polish Army Stadium", new LocationTitleUri("Polish Army Stadium", "http://dbpedia.org/resource/Polish_Army_Stadium"))
            .put("RheinEnergieSTADION", new LocationTitleUri("RheinEnergieStadion", "http://dbpedia.org/resource/RheinEnergieStadion"))
            .put("BORUSSIA-PARK", new LocationTitleUri("Borussia Park", "http://dbpedia.org/resource/Borussia-Park"))
            .put("Red Bull Arena", new LocationTitleUri("Red Bull Arena", "http://dbpedia.org/resource/Red_Bull_Arena_(New_Jersey)"))
//            .put("OPEL ARENA", new LocationTitleUri("", "http://dbpedia.org/resource/")) // CANNOT BE MATCHED https://en.wikipedia.org/wiki/Opel_Arena_(stadium)
            .put("Weser-Stadion", new LocationTitleUri("Weserstadion", "http://dbpedia.org/resource/Weserstadion"))
            .put("Northern Commercials Stadium", new LocationTitleUri("Valley Parade", "http://dbpedia.org/resource/Valley_Parade"))
            ...
            .put("Amex Stadium", new LocationTitleUri("Falmer Stadium", "http://dbpedia.org/resource/Falmer_Stadium"))
            .build();
