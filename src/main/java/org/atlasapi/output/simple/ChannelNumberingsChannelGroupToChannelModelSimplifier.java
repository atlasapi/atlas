...
public class ChannelNumberingsChannelGroupToChannelModelSimplifier implements ModelSimplifier<Iterable<ChannelNumbering>, Iterable<org.atlasapi.media.entity.simple.ChannelNumbering>> {
    ...
    public ChannelNumberingsChannelGroupToChannelModelSimplifier(
            ChannelResolver channelResolver,
            ChannelNumberingChannelModelSimplifier channelSimplifier
    ) {
        ...
        if (annotations.contains(Annotation.HISTORY)) {
            ...
            return Iterables.concat(Iterables.transform(
                    ...
                    input -> {
                        ...
                        return simplifyChannelNumberingsWithHistory(numberings, history, application, annotations);
                    }
            ));
        } else {
            return Iterables.transform(
                    ...
                    input -> {
                        org.atlasapi.media.entity.simple.ChannelNumbering simple = simplifyNumbering(input, null, application, annotations);
    ...
    private Iterable<HistoricalChannelNumberingEntry> generateHistory(
    ...
    private org.atlasapi.media.entity.simple.ChannelNumbering simplifyNumbering(
        ...
        simple.setChannel(channelSimplifier.simplify(channel.requireValue(), 
                retainAnnotationsForChannelSimplification(annotations), application));
    ...
    private Iterable<org.atlasapi.media.entity.simple.ChannelNumbering> simplifyChannelNumberingsWithHistory(
        ...
        if (Iterables.isEmpty(currentNumberings)) {
            ...
            return ImmutableList.of(simplifyNumbering(Iterables.get(numberings, 0), history, application, annotations));
        } else {
            ...
            for (ChannelNumbering currentNumbering : currentNumberings) {
                org.atlasapi.media.entity.simple.ChannelNumbering simple = simplifyNumbering(currentNumbering, history, application, annotations);
