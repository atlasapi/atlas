...
public class PaModule {
    ...
    @Bean PaProgDataProcessor paProgrammeProcessor() {
        return new PaProgrammeProcessor(contentWriter, contentBuffer(), log, new PaTagMap(topicStore, mongo));
    }
    ...
    @Bean PaArchivesUpdater paRecentArchivesUpdater() {
        PaProgDataUpdatesProcessor paProgDataUpdatesProcessor = new PaProgrammeProcessor(contentWriter, contentBuffer(), log, new PaTagMap(topicStore, mongo));
