...
public class ContentTitleScorerTest {
    ...
    public void testScoreWithAmpersands() {
        score(1.5, score("Rosencrantz & Guildenstern Are Dead", "Rosencrantz and Guildenstern Are Dead"));
        score(1.5, score("Bill & Ben", "Bill and Ben"));
    }
    
    @Test
    public void testScoreWithCommonPrefix() {
        score(1.5, score("The Great Escape", "The Great Escape"));
        scoreLt(0.1, score("The Great Escape", "Italian Job"));
        
        score(1.5, score("The Great Escape", "Great Escape"));
        score(1.5, score("the Great Escape", "Great Escape"));
