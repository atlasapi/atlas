...
public class AmazonUnboxContentExtractor implements ContentExtractor<AmazonUnboxItem,
    ...
    private Content extractBrand(AmazonUnboxItem source) {
        ...
        //order we ingest episodes. This causes the brand to be marked as updated and get reuploaded
        //to YV in an always changing loop. YV has agreed that duplicating the title is acceptable.
