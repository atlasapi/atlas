...
public class AmazonUnboxUpdateTask extends ScheduledTask {
    ...
    protected void runTask() {
        ...
        try  {
            ...
            telescope.reportFailedEvent("An exception has prevented this task from completing properly (" +
                    e.getMessage() + ")");
    ...
    private AmazonUnboxProcessor<UpdateProgress> processor(final AmazonUnboxItemProcessor handler, OwlTelescopeReporter telescope) {
        return new AmazonUnboxProcessor<UpdateProgress>() {
            ...
            public boolean process(AmazonUnboxItem aUItem) {
                try {
                    ...
                    telescope.reportFailedEvent("Error processing: " + aUItem.toString() + " (" + e.getMessage());
