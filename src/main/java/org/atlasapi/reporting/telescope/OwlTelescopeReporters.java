...
public enum OwlTelescopeReporters implements TelescopeReporterName {
    ...
    CHANNEL_4_INGEST_ATOZ("channel4.ingester.atoz", "Channel 4 Ingester A to Z"),
    CHANNEL_4_INGEST_UPDATER("channel4.ingester.updater", "Channel 4 Ingester Updater"),
    ...
    CONTENT_CHANGES_EQUIVALENCE_UPDATING_WORKER("equivalence.content-changes-worker", "Content Changes Equivalence Worker"),
    EQUIVALENCE_CHANGES_EQUIVALENCE_UPDATING_WORKER("equivalence.equivalence-changes-worker", "Equivalence Changes Equivalence Worker"),
