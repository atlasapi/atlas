...
public class BbcTxlogsItemUpdaterProvider implements EquivalenceResultUpdaterProvider<Item> {
    ...
    public EquivalenceResultUpdater<Item> getUpdater(
        ...
        //Tighten txlog to bbc equiv because it was mis-equiv'ing to some low scored candidates
        //generated by BarbBroadcast. Bbc to txlog should stay the same. ENG-447
        if(isSubjectTxlog) {
